...
@endsection
@section('content')
    <x-page-header title="Modifier {{ $client->name }}" />
    <div class="max-w-2xl">
            ...
            <div class="bg-gray-900 rounded-xl border border-gray-800 p-6">
                ...
                <div class="grid grid-cols-1 gap-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm text-gray-400 mb-1.5">Prénom *</label>
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        ...
                        <div>
                            <label class="block text-sm text-gray-400 mb-1.5">Pays</label>
                            <input type="text" name="country_code" value="{{ old('country_code', $client->country_code) }}" maxlength="2"
                                class="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-2.5 text-white focus:outline-none focus:ring-2 focus:ring-indigo-500">
                        </div>
                    </div>
                    <div>
                        <label class="block text-sm text-gray-400 mb-1.5">N° TVA</label>
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <label for="active" class="text-sm text-gray-300">Compte actif</label>
                    </div>
                </div>
            </div>
