    ...
    <div class="max-w-2xl mx-auto">
        <form method="POST" action="{{ route('admin.skills.update', $skill) }}" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="slug" value="{{ old('slug', $skill->slug) }}" required
            ...
            <div>
                ...
                <textarea name="description" rows="2"
                    class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">{{ old('description', $skill->description) }}</textarea>
            </div>
            ...
            <div>
                ...
                <select name="handler_type" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    <option value="prompt" {{ old('handler_type', $skill->handler_type) === 'prompt' ? 'selected' : '' }}>Prompt</option>
                    <option value="native_tool" {{ old('handler_type', $skill->handler_type) === 'native_tool' ? 'selected' : '' }}>Native Tool</option>
                    <option value="composite" {{ old('handler_type', $skill->handler_type) === 'composite' ? 'selected' : '' }}>Composite</option>
                </select>
            </div>
            ...
            <div>
                ...
                <textarea name="prompt_template" rows="5" required
                    class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-white text-sm font-mono focus:outline-none focus:ring-2 focus:ring-indigo-500">{{ old('prompt_template', $skill->prompt_template) }}</textarea>
            </div>
            ...
            <div>
                ...
                <textarea name="parameter_schema" rows="6"
                    class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-white text-sm font-mono focus:outline-none focus:ring-2 focus:ring-indigo-500">{{ old('parameter_schema', $skill->parameter_schema ? json_encode($skill->parameter_schema, JSON_PRETTY_PRINT) : '') }}</textarea>
            </div>
            ...
            <div>
                ...
                <textarea name="output_schema" rows="4"
                    class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-white text-sm font-mono focus:outline-none focus:ring-2 focus:ring-indigo-500">{{ old('output_schema', $skill->output_schema ? json_encode($skill->output_schema, JSON_PRETTY_PRINT) : '') }}</textarea>
            </div>
            ...
            <div>
                ...
                <input type="text" name="allowed_tools" value="{{ old('allowed_tools', json_encode($skill->allowed_tools ?? [])) }}"
                    class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-white text-sm font-mono focus:outline-none focus:ring-2 focus:ring-indigo-500">
            </div>
            ...
            <div>
                ...
                <input type="text" name="action_handlers" value="{{ old('action_handlers', json_encode($skill->action_handlers ?? [])) }}"
                    class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-white text-sm font-mono focus:outline-none focus:ring-2 focus:ring-indigo-500">
            </div>
