@extends('layouts.app')
@section('title', __('app.credit_note_label', ['number' => $creditNote->number]))
...
@php
    ...
    $sl = ['draft'=>__('app.status_draft'),'issued'=>__('app.status_issued')];
@endphp
...
<div class="grid lg:grid-cols-3 gap-6">
    <div class="lg:col-span-2 space-y-6">
        ...
        <div class="bg-gray-900 rounded-xl border border-gray-800 p-6">
            <div class="grid grid-cols-2 gap-6">
                ...
                <div class="space-y-3">
                    <div>
                        <p class="text-xs font-semibold text-gray-500 uppercase mb-1">{{ __('app.linked_invoice') }}</p>
                    ...
                    <div>
                        <p class="text-xs font-semibold text-gray-500 uppercase mb-1">{{ __('app.reason') }}</p>
        ...
        <div class="bg-gray-900 rounded-xl border border-gray-800 overflow-hidden">
            <div class="px-5 py-4 border-b border-gray-800">
                <h3 class="font-semibold text-white">{{ __('app.credit_note_lines') }}</h3>
            </div>
            <table class="w-full text-sm">
                <thead>
                    <tr class="border-b border-gray-800">
                        ...
                        <th class="text-right text-xs font-semibold text-gray-500 uppercase px-5 py-3">{{ __('app.amount_ttc_col') }}</th>
                    </tr>
                </thead>
    ...
    <div class="space-y-4">
        <div class="bg-gray-900 rounded-xl border border-gray-800 p-5">
            <p class="text-xs font-semibold text-gray-500 uppercase mb-3">{{ __('app.credit_note_amount') }}</p>
