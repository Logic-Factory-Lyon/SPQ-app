...
<p class="sidebar-section">{{ __('app.clients') }}</p>
...
<p class="sidebar-section">{{ __('app.billing') }}</p>
<a href="{{ route('admin.quotes.index') }}"
   class="sidebar-link {{ request()->routeIs('admin.quotes.*') ? 'active' : '' }}">
    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
<p class="sidebar-section">{{ __('app.communication') }}</p>
...
<p class="sidebar-section">{{ __('app.settings') }}</p>
...
<a href="{{ route('admin.services.index') }}"
   class="sidebar-link {{ request()->routeIs('admin.services.*') ? 'active' : '' }}">
    ...
    {{ __('app.service_catalog') }}
</a>
<a href="{{ route('admin.vat-rates.index') }}"
   class="sidebar-link {{ request()->routeIs('admin.vat-rates.*') ? 'active' : '' }}">
    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
